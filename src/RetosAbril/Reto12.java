...
public class Reto12 {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.print("Introduce un número entero o 'fin': ");
            entrada = sc.nextLine();
            ...
            try {
                ...
                System.out.println("Por favor, introduce un número entero o 'fin'");
            }
        }

        System.out.println("\nSe encontraron " + contadorSuerte + " números de la suerte");
    }
}